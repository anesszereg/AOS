...
-- Food Delivery Platform - Full Test Data
-- ============================================
...
-- Insert profiles
INSERT INTO profiles (user_id, name, phone, avatar) VALUES
('11111111-1111-1111-1111-111111111111', 'John Customer', '+1-555-0001', 'https://ui-avatars.com/api/?name=John+Customer&background=FF5722&color=fff'),
('11111111-1111-1111-1111-111111111112', 'Jane Smith', '+1-555-0002', 'https://ui-avatars.com/api/?name=Jane+Smith&background=2196F3&color=fff'),
('11111111-1111-1111-1111-111111111113', 'Bob Johnson', '+1-555-0003', 'https://ui-avatars.com/api/?name=Bob+Johnson&background=4CAF50&color=fff'),
('22222222-2222-2222-2222-222222222221', 'Luigi Rossi', '+1-555-1001', 'https://ui-avatars.com/api/?name=Luigi+Rossi&background=FF9800&color=fff'),
('22222222-2222-2222-2222-222222222222', 'Takeshi Yamamoto', '+1-555-1002', 'https://ui-avatars.com/api/?name=Takeshi+Yamamoto&background=9C27B0&color=fff'),
('22222222-2222-2222-2222-222222222223', 'Mike Anderson', '+1-555-1003', 'https://ui-avatars.com/api/?name=Mike+Anderson&background=F44336&color=fff'),
('33333333-3333-3333-3333-333333333331', 'Driver Mike', '+1-555-2001', 'https://ui-avatars.com/api/?name=Driver+Mike&background=00BCD4&color=fff'),
('33333333-3333-3333-3333-333333333332', 'Driver Sarah', '+1-555-2002', 'https://ui-avatars.com/api/?name=Driver+Sarah&background=E91E63&color=fff'),
('44444444-4444-4444-4444-444444444441', 'Admin User', '+1-555-3001', 'https://ui-avatars.com/api/?name=Admin+User&background=607D8B&color=fff');
...
SELECT 'Users created: ' || COUNT(*) AS users FROM auth_db.users;
SELECT 'Restaurants created: ' || COUNT(*) AS restaurants FROM restaurant_db.restaurants;
SELECT 'Menu items created: ' || COUNT(*) AS menu_items FROM menu_db.menu_items;
SELECT 'Profiles created: ' || COUNT(*) AS profiles FROM user_db.profiles;
