...
// Vercel-hosted frontend connects to deployed backend on Render
// For local development, use http://localhost:8000/api
const API_BASE_URL = import.meta.env.VITE_API_URL || 'https://food-delevery-app-g73l.onrender.com/api';
